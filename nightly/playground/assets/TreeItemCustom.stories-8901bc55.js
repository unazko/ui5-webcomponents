import{x as r}from"./lit-element-c5a2b594.js";import{o as n}from"./unsafe-html-0ddd83da.js";import{l as t}from"./if-defined-c29cffe1.js";const c={additionalTextState:{control:"select",options:["None","Success","Warning","Error","Information"]},type:{control:"select",options:["Inactive","Active","Detail","Navigation"]},content:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},default:{control:{type:"text"},table:{type:{summary:"Array<TreeItemBase>"}}},deleteButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}},toggle:{description:"Call this method to manually switch the <code>expanded</code> state of a tree item.",table:{category:"methods"},UI5CustomData:{returnValue:{type:{text:"void"}}}}},$={package:"@ui5/webcomponents",since:"1.9.2",tagName:"ui5-tree-item-custom",showDefaultStoryOnly:!0},d={title:"Main/Tree/Tree Item Custom",component:"TreeItemCustom",argTypes:c},l=e=>r`<ui5-tree>
...
</ui5-tree>`,i=l.bind({});i.tags=["_hidden_"];i.args={expanded:!0,content:'<ui5-button slot="content">Level 1</ui5-button>',default:`<ui5-tree-item-custom>
...
</ui5-tree>\``,...(s=(a=i.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};const u=["Basic"],y=Object.freeze(Object.defineProperty({__proto__:null,Basic:i,__namedExportsOrder:u,default:d},Symbol.toStringTag,{value:"Module"}));export{y as C,$ as c};
