import{x as $}from"./lit-element-c5a2b594.js";import{l as n}from"./if-defined-c29cffe1.js";import{o as a}from"./unsafe-html-0ddd83da.js";import{I as y}from"./IllustrationMessageType-f0f4890b.js";const x={size:{control:"select",options:["Auto","Base","Spot","Dialog","Scene"]},titleLevel:{control:"select",options:["H1","H2","H3","H4","H5","H6"]},title:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement> & string"}}},subtitle:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},default:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}}},I={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.15",tagName:"ui5-illustrated-message"};var l=Object.freeze,v=Object.defineProperty,L=(e,T)=>l(v(e,"raw",{value:l(T||e.slice())})),s;const h={title:"Fiori/Illustrated Message",component:"IllustratedMessage",argTypes:x},D=e=>$` <ui5-illustrated-message
    name="${n(e.name)}"
    size="${n(e.size)}"
...
>
    ...
    ${a(e.subtitle)}
    ${a(e.default)}
</ui5-illustrated-message>`,i=D.bind({});i.args={name:y.UnableToUpload,default:`
    ...
    <\/script>
`]))),t=D.bind({});t.args={name:y.UnableToUpload,title:`
