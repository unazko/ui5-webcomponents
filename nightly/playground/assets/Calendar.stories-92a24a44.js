...
create instances of <code>ui5-date</code> for the newly selected dates. In that case you should do this manually.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"Array<string>"},name:"values",_ui5privacy:"public",description:"The selected dates"},{type:{text:"Array<number>"},name:"dates",_ui5privacy:"public",description:"The selected dates as UTC timestamps"}]}}},A={package:"@ui5/webcomponents",since:"1.0.0-rc.11",tagName:"ui5-calendar"};var o=Object.freeze,S=Object.defineProperty,_=(e,x)=>o(S(e,"raw",{value:o(x||e.slice())})),l;const w={title:"Main/Calendar",component:"Calendar",argTypes:v},i=e=>b`<ui5-calendar
