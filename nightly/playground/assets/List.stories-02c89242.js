...
in <code>SingleSelect</code>, <code>SingleSelectBegin</code>, <code>SingleSelectEnd</code> and <code>MultiSelect</code> modes.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"Array<ListItemBase>",references:[{name:"ListItemBase",package:"@ui5/webcomponents",module:"dist/ListItemBase.js"}]},name:"selectedItems",_ui5privacy:"public",description:"An array of the selected items."},{type:{text:"Array<ListItemBase>",references:[{name:"ListItemBase",package:"@ui5/webcomponents",module:"dist/ListItemBase.js"}]},name:"previouslySelectedItems",_ui5privacy:"public",description:"An array of the previously selected items."}]}}},P={package:"@ui5/webcomponents",tagName:"ui5-list"};var s=Object.freeze,B=Object.defineProperty,N=(e,$)=>s(B(e,"raw",{value:s($||e.slice())})),c;const L={title:"Main/List",component:"List",argTypes:E},T=e=>r` <ui5-list
    mode="${i(e.mode)}"
    ?busy="${i(e.busy)}"
    ?indent="${i(e.indent)}"
    ?growing="${i(e.growing)}"
  ...
  >
    ...
    <ui5-li
        ...
        >Mango</ui5-li>`};const n=()=>r(c||(c=N([`<ui5-list id="infiniteScrollEx" style="height: 200px" growing="Scroll">
      <ui5-li
        icon="nutrition-activity"
        description="Tropical plant with an edible fruit"
        additional-text="In-stock"
...
\``,...(b=(h=o.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var x,v,S;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:`args => {
  return html\` <ui5-list
    mode="\${ifDefined(args.mode)}"
    ?busy="\${ifDefined(args.busy)}"
    ?indent="\${ifDefined(args.indent)}"
  ...
  >
...
}`,...(S=(v=a.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};var D,w,I;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`() => html\` <ui5-list
      header-text="No separators"
      separators="None"
      class="full-width"
    >
    ...
    >
      ...
      <ui5-li icon="shipping-status">Pending</ui5-li>
      <ui5-li icon="shipping-status">Declined</ui5-li>
    </ui5-list>\``,...(I=(w=l.parameters)==null?void 0:w.docs)==null?void 0:I.source}}};const A=["Basic","Growing","Modes","GroupHeaders","SeparationTypes"],F=Object.freeze(Object.defineProperty({__proto__:null,Basic:t,GroupHeaders:a,Growing:n,Modes:o,SeparationTypes:l,__namedExportsOrder:A,default:L},Symbol.toStringTag,{value:"Module"}));export{F as C,P as c};
