import{s as x}from"./index.5ca63ce8.js";import{d as B}from"./index.b38f6aa4.js";const{logger:S}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var p="backgrounds",{document:s,window:_}=x,w=()=>_.matchMedia("(prefers-reduced-motion: reduce)").matches,A=(r,e=[],n)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let t=e.find(a=>a.name===n);if(t)return t.value;if(n){let a=e.map(i=>i.name).join(", ");S.warn(B`
...
//# sourceMappingURL=preview.b4b8bf1a.js.map
