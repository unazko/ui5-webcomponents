import{x as n}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o as d}from"./unsafe-html-0ddd83da.js";const o={design:{control:"select",options:["Standard","NoCurrentPage"]},separatorStyle:{control:"select",options:["Slash","BackSlash","DoubleBackSlash","DoubleGreaterThan","DoubleSlash","GreaterThan"]},default:{control:{type:"text"},table:{type:{summary:"Array<BreadcrumbsItem>"}}},"item-click":{description:`Fires when a <code>BreadcrumbsItem</code> is clicked.
