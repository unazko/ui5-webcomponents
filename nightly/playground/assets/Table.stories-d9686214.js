...
in <code>SingleSelect</code> and <code>MultiSelect</code> modes.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"Array"},name:"selectedRows",_ui5privacy:"public",description:"An array of the selected rows."},{type:{text:"Array"},name:"previouslySelectedRows",_ui5privacy:"public",description:"An array of the previously selected rows."}]}}},J={package:"@ui5/webcomponents",tagName:"ui5-table"};var p=Object.freeze,W=Object.defineProperty,U=(l,E)=>p(W(l,"raw",{value:p(E||l.slice())})),g,m;let e=0;const K={title:"Main/Table",component:"Table",argTypes:j},b=l=>s`
<ui5-table
    id="table-${++e}"
