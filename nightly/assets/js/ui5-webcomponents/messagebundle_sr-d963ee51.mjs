const E = "Садржај картице", _ = "Картица", T = "Заглавље картице", A = "Заглавље интерактивне картице", I = "Аватар", R = "{0} приказано, {1} сакривено.", O = "Активирајте да бисте добили потпуну листу.", L = "Појединачни аватари.", N = "Спојени аватари.", S = "Притисните СТРЕЛИЦЕ на тастатури да бисте се кретали.", C = "Ознака", D = "Ознака", P = "Дугме ознаке", B = "Грешка", U = "Упозорење", t = "Успех", s = "Информације", n = "{0} од {1}", o = "Пут усмеравања", c = "Више", M = "Одустани", G = "Сачекајте", K = "Позитивна радња", H = "Негативна радња", V = "Наглашено", X = "од", Y = "Ставка {0} од {1} приказана", W = "Претходна страница", F = "Следећа страница", Z = "Палета боја - претходно дефинисане боје", e = "Палета боја", a = "Боја", f = "Одустани", l = "ОК", r = "Промени боју", d = "Више боја...", h = "Стандардна боја", i = "Алфа контрола", u = "Контрола нијансе", J = "Хексадецимално", Q = "Црвена", b = "Зелена", g = "Плава", m = "Алфа", p = "Отвори алат за одабир", x = "Унос датума", j = "Унос датума/времена", k = "Унос распона датума", q = "Избриши", v = "Претражи...", w = "Пренеси фајл на сервер", y = "Заглавље групе", z = "Поље листе", $ = "Опције одабира", EE = "Покажи само одабране ставке", _E = "Предлози су доступни", TE = "Одабери све ({0} од {1})", AE = "Одабери", IE = "1 резултат доступан", RE = "{0} резултата је доступно", OE = "Нема резултата", LE = "Поништи", NE = "Суптилно", SE = "Наглашено", CE = "Ставке листе {0} од {1}", DE = "Одабрано", PE = "Није одабрано", BE = "Заглавље групе", UE = "Начин вишеструког одабира", tE = "Одабир ставке.", sE = "Садржи ставке које се могу одабрати", nE = "Садржи ставке с могућношћу вишеструког одабира", oE = "Садржи ставке које се могу избрисати", cE = "Затварање траке са информацијама", ME = "Може се затворити", GE = "Трака са информацијама за грешку", KE = "Трака са информацијама за упозорење", HE = "Трака са информацијама за успех", VE = "Трака са информацијама", XE = "ОК", YE = "Одаберите једну од доступних опција.", WE = "Ова вредност је већ одабрана.", FE = "Унос вишеструке вредности", ZE = "{0} више", eE = "Прошири/сажми", aE = "Распон", fE = "Леви регулатор", lE = "Десни регулатор", rE = "Вредновање", dE = "Показатељ вредновања", hE = "Обавезно", iE = "Одбиј", uE = "Група сегментиране дугмади", JE = "Притисните РАЗМАК или ENTER да бисте одабрали ставку", QE = "Сегментирано дугме", bE = "Регулатор клизача", gE = "Више", mE = "Ред заглавља 1 од {0}", pE = "{0} од {1}", xE = "Ред заглавља групе", jE = "Одабир ставке", kE = "Одабери све редове", qE = "Празно", vE = "Позитивно", wE = "Негативно", yE = "Критично", zE = "Неутрално", $E = "Картица с подставкама", E_ = "Следеће", __ = "Претходно", T_ = "Мени прекорачења", A_ = "Више", I_ = "Одустани", R_ = "Притисните стрелицу за доле да отворите мени подставки", O_ = "{0} знакова преостаје", L_ = "{0} знакова прекорачено", N_ = "Сати", S_ = "Минути", C_ = "Секунде", D_ = "ОК", P_ = "Одустани", B_ = "Унос времена", U_ = "Бројчаник сата", t_ = "Унесите сате", s_ = "Унесите минуте", n_ = "Унесите секунде", o_ = "Унос трајања", c_ = "Датум", M_ = "Време", G_ = "Може се избрисати", K_ = "Нема токена", H_ = "Садржи 1 токен", V_ = "Садржи {0} токена", X_ = "Генератор токена", Y_ = "Уклони", W_ = "{0} ставке(и)", F_ = "Ставка стабла", Z_ = "Прошири чвор", e_ = "Сажми чвор", a_ = "Статус вредности - Грешка", f_ = "Статус вредности - Упозорење", l_ = "Статус вредности - Успех", r_ = "Статус вредности - Информације", d_ = "Неважећи унос", h_ = "Упозорења издато", i_ = "Информативни унос", u_ = "Унос успешно валидиран", J_ = "Следеће", Q_ = "Претходно", b_ = "Број недеље", g_ = "Нерадни дан", m_ = "Данас", p_ = "Одабир месеца", x_ = "Одабир године", j_ = "Смањи", k_ = "Повећај", q_ = "Дугме Подели", v_ = "Притисните Размак или Enter за покретање стандардне радње и Alt + Стрелица доле или F4 за покретање радње стрелице", w_ = "Назад", y_ = "Одбиј", z_ = "Усмеравање", $_ = "Интерактивно заглавље", ET = "Користите Shift+стрелице на тастатури за промену величине", _T = "Користите стрелице на тастатури за кретање", TT = "Користите стрелице на тастатури за кретање, Shift+стрелице на тастатури за промену величине", AT = ":", IT = "Додатне опције", RT = {
