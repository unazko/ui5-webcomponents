const E = "Съдържание на карта", _ = "Карта", T = "Заглавна част на карта", A = "Интерактивна заглавна част на карта", I = "Аватар", R = "{0} показани, {1} скрити.", O = "Активиране за пълен списък.", L = "Индивидуални аватари.", N = "Свързани аватари.", S = "Придвижвайте се чрез клавишите със стрелки.", C = "Значка", D = "Таг", P = "Бутон на таг", B = "Грешка", U = "Предупреждение", t = "Успешно изпълнение", s = "Информация", n = "{0} от {1}", o = "Път на навигация", c = "Още", M = "Отказ", G = "Моля, изчакайте", K = "Положително действие", H = "Отрицателно действие", V = "Подчертано", X = "от", Y = "Позиция {0} от {1} показани", W = "Предишна страница", F = "Следваща страница", Z = "Цветова палитра - предварително определени цветове", e = "Цветова палитра", a = "Цвят", f = "Отказ", l = "OK", b = "Промяна на цвят", d = "Още цветове...", g = "Цвят по подразбиране", h = "Алфа-контрол", i = "Контрол на цветове", r = "Шестнадесетичен", u = "Червен", J = "Зелен", Q = "Син", m = "Алфа", p = "Отваряне на средство за избор", x = "Въвеждане на дата", j = "Въвеждане на дата и час", k = "Въвеждане на диапазон от дати", q = "Изтриване", v = "Браузване...", w = "Качване на файл", y = "Заглавна част на група", z = "Клетка на списък", $ = "Избиране на опции", EE = "Показване само на избраните позиции", _E = "Има налични предложения", TE = "Избор на всички ({0} от {1})", AE = "Избор", IE = "1 резултат е наличен", RE = "{0} резултати са налични", OE = "Няма резултати", LE = "Изчистване", NE = "Блед", SE = "Подчертано", CE = "Позиция от списък {0} от {1}", DE = "Избрани", PE = "Неизбрано", BE = "Заглавие на група", UE = "Режим на множествен избор", tE = "Избор на позиция.", sE = "Съдържа подлежащи на избор позиции", nE = "Съдържа подлежащи на множествен избор позиции", oE = "Съдържа подлежащи на изтриване позиции", cE = "Затваряне на лента с информация", ME = "Може да се затвори", GE = "Лента с информация за грешки", KE = "Лента с предупреждения", HE = "Лента с информация за успешни изпълнения", VE = "Лента с информация", XE = "OK", YE = "Изберете една от наличните опции.", WE = "Тази стойност вече е избрана.", FE = "Въвеждане на множество стойности", ZE = "Още {0}", eE = "Разширяване/скриване", aE = "Диапазон", fE = "Ляв регулатор", lE = "Десен регулатор", bE = "Оценка", dE = "Индикатор за рейтинг", gE = "Задължително", hE = "Отхвърляне", iE = "Група на сегментиран бутон", rE = "Натиснете клавиша за интервал или ENTER, за да изберете позиция", uE = "Сегментиран бутон", JE = "Регулатор на плъзгач", QE = "Други", mE = "Заглавен ред 1 от {0}", pE = "{0} от {1}", xE = "Заглавен ред на група", jE = "Избор на позиция", kE = "Изберете всички редове", qE = "Празно", vE = "Положително", wE = "Отрицателно", yE = "Критично", zE = "Неутрално", $E = "Таб с подпозиции", E_ = "Напред", __ = "Назад", T_ = "Меню препълване", A_ = "Още", I_ = "Отказ", R_ = "Натиснете клавиша със стрелка надолу, за да отворите менюто с подпозиции", O_ = "Остават {0} символа", L_ = "{0} символа над ограничението", N_ = "Часове", S_ = "Минути", C_ = "Секунди", D_ = "OK", P_ = "Отказ", B_ = "Въвеждане на час", U_ = "Циферблат на часовник", t_ = "Моля, въведете час", s_ = "Моля, въведете минути", n_ = "Моля, въведете секунди", o_ = "Въвеждане на времетраене", c_ = "Дата", M_ = "Час", G_ = "С възможност за изтриване", K_ = "Няма токени", H_ = "Съдържа 1 токен", V_ = "Съдържа {0} токена", X_ = "Генератор за токени", Y_ = "Премахване", W_ = "{0} позиции", F_ = "Позиция от дърво", Z_ = "Разширяване на възел", e_ = "Скриване на възел", a_ = 'Статус стойност "Грешка”', f_ = 'Статус стойност "Предупреждение"', l_ = 'Статус стойност "Успех"', b_ = "Статус стойност “Информация”", d_ = "Невалиден запис", g_ = "Изведено предупреждение", h_ = "Информативен запис", i_ = "Записът е успешно проверен", r_ = "Напред", u_ = "Назад", J_ = "Номер на седмица", Q_ = "Неработен ден", m_ = "Днес", p_ = "Избор на месец", x_ = "Избор на година", j_ = "Намаляване", k_ = "Увеличаване", q_ = "Бутон разделяне", v_ = "Натиснете интервал или Enter, за да инициирате действие по подразбиране и Alt + стрелка надолу или F4, за да инициирате действие на стрелка.", w_ = "Назад", y_ = "Отхвърляне", z_ = "Навигация", $_ = "Интерактивно заглавие", ET = "Изберете Shift+стрелки, за да промените размера", _T = "Придвижвайте се чрез клавишите със стрелки", TT = "Придвижвайте се чрез клавишите със стрелки, а променяйте размера с Shift+стрелки", AT = ":", IT = "Допълнителни опции", RT = {
