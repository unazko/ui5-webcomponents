const E = "محتوى البطاقة", _ = "البطاقة", T = "مقدمة البطاقة", A = "مقدمة بطاقة تفاعلية", I = "صورة رمزية (أفاتار)", R = "{0} معروض، {1} مخفي.", O = "قم بالتنشيط للقائمة بأكملها.", L = "الأفاتارز الفردية.", N = "الأفاتارز المربوطة.", S = "اضغط على مفاتيح الأسهم للنقل.", C = "شارة", D = "Tag", P = "Tag button", B = "خطأ", U = "تحذير", t = "نجاح", o = "معلومات", n = "{0} من {1}", s = "مسار التنقل", c = "المزيد", M = "إلغاء", G = "الرجاء الانتظار", K = "إجراء موجب", H = "إجراء سالب", V = "مؤكد", X = "من", Y = "تم عرض {0} من {1}", W = "الصفحة السابقة", F = "الصفحة التالية", Z = "لوحة الألوان - الألوان المحددة مسبقًا", r = "لوحة الألوان", a = "اللون", e = "إلغاء", w = "موافق", f = "تغيير اللون", g = "مزيد من الألوان...", l = "اللون الافتراضي", u = "عنصر تحكم ألفا", b = "عنصر تحكم تدرج اللون", d = "ست عشري", h = "أحمر", i = "أخضر", p = "أزرق", J = "ألفا", Q = "فتح أداة الانتقاء", m = "إدخال التاريخ", x = "إدخال التاريخ/الوقت", j = "إدخال نطاق التواريخ", k = "حذف", q = "استعراض...", v = "تحميل ملف", y = "مقدمة المجموعة", z = "مربع القائمة", $ = "تحديد الخيارات", EE = "إظهار البنود المحددة فقط", _E = "اقترحات متوفرة", TE = "تحديد الكل ({0} من أصل {1})", AE = "تحديد", IE = "النتيجة المتوفرة: 1", RE = "{0} النتائج متوفرة", OE = "لا توجد نتائج", LE = "مسح", NE = "غامض", SE = "مؤكد", CE = "بند القائمة {0} لـ {1}", DE = "محدد", PE = "غير محدد", BE = "مقدمة المجموعة", UE = "نمط التحديد المتعدد", tE = "تحديد البنود.", oE = "توجد بنود قابلة للتحديد", nE = "توجد بنود قابلة لتحديد متعدد", sE = "توجد بنود قابلة للحذف", cE = "إغلاق شريط المعلومات", ME = "ممكن إغلاقه", GE = "شريط معلومات الخطأ", KE = "شريط معلومات التحذير", HE = "شريط معلومات النجاح", VE = "شريط المعلومات", XE = "موافق", YE = "حدد أحد الخيارات المتوفرة.", WE = "هذه القيمة محددة بالفعل.", FE = "إدخال متعدد القيمة", ZE = "{0} إضافي", rE = "توسيع/طي", aE = "النطاق", eE = "المؤشر الأيمن", wE = "المؤشر الأيسر", fE = "التصنيف", gE = "مؤشر التقييم", lE = "مطلوب", uE = "رفض", bE = "مجموعة الأزرار المقسَّمة", dE = "اضغط على SPACE أو ENTER لتحديد أحد البنود", hE = "الزر المقسَّم", iE = "مؤشر مربع التمرير", pE = "المزيد", JE = "صف المقدمة 1 من أصل {0}", QE = "{0} من {1}", mE = "صف مقدمة المجموعة", xE = "تحديد البنود", jE = "تحديد كل الصفوف", kE = "فارغ", qE = "إيجابية", vE = "سلبية", yE = "مهم", zE = "محايد", $E = "علامة تبويب بالبنود الفرعية", E_ = "التالي", __ = "السابق", T_ = "قائمة التدفق", A_ = "المزيد", I_ = "إلغاء", R_ = "اضغط على مفتاح السهم لأسفل لفتح قائمة البنود الفرعية", O_ = "متبق {0} من الحروف", L_ = "تم تجاوز الحد بمقدار {0} من الحروف", N_ = "الساعات", S_ = "الدقائق", C_ = "الثواني", D_ = "موافق", P_ = "إلغاء", B_ = "إدخال الوقت", U_ = "طلب الساعة", t_ = "يُرجى إدخال الساعات", o_ = "يُرجى إدخال الدقائق", n_ = "يُرجى إدخال الثواني", s_ = "إدخال المدة", c_ = "التاريخ", M_ = "الوقت", G_ = "قابل للحذف", K_ = "لا توجد رموز مميزة", H_ = "يتضمن رمز مميز واحد", V_ = "يحتوى على {0} من الرموز المميزة", X_ = "عارض الرموز المميزة", Y_ = "إزالة", W_ = "{0} من البنود", F_ = "عنصر الشجرة", Z_ = "توسيع العقدة", r_ = "طي العقدة", a_ = "حالة القيمة ’خطأ‘", e_ = "حالة القيمة ’تحذير‘", w_ = "حالة القيمة ناجح", f_ = "حالة القيمة ’معلومات‘", g_ = "إدخال غير صالح", l_ = "تم إصدار تحذير", u_ = "إدخال معلوماتي", b_ = "تم التحقق من صحة الإدخال بنجاح", d_ = "التالي", h_ = "السابق", i_ = "رقم الأسبوع", p_ = "يوم عطلة", J_ = "اليوم", Q_ = "أداة انتقاء الشهر", m_ = "أداة انتقاء السنة", x_ = "تخفيض", j_ = "زيادة", k_ = "زر التقسيم", q_ = "اضغط على Space أو Enter لبدء تشغيل الإجراء الافتراضي وAlt + Arrow Down أو F4 لبدء تشغيل إجراء السهم", v_ = "الخلف", y_ = "رفض", z_ = "تنقل", $_ = "مقدمة تفاعلية", ET = "استخدام مفاتيح Shift+Arrow لتغيير الحجم", _T = "استخدام مفاتيح الأسهم للانتقال", TT = "استخدام مفاتيح الأسهم للانتقال، مفاتيح Shift+Arrow لتغيير الحجم", AT = ":", IT = "خيارات إضافية", RT = {
  ...
  COLOR_PALETTE_DEFAULT_COLOR_TEXT: l,
...
export {
  ...
  l as COLOR_PALETTE_DEFAULT_COLOR_TEXT,
