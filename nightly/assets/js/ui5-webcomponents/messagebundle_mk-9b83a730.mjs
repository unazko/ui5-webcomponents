const T = "Откажи", I = "Се вчитува", _ = "Прва колона", E = "Средна колона", L = "Последна колона", O = "Прошири ја првата колона", A = "Скриј ја првата колона", N = "Прошири ја последната колона", S = "Скриј ја последната колона", C = "Известување", R = "Прикажи повеќе", D = "Покажи помалку", M = "Повеќе", U = "Затвори", B = "Причитано", P = "Непрочитано", t = "Висок приоритет", n = "Среден приоритет", o = "Низок приоритет", s = "Група известувања", c = "Бројач", F = "Затвори сè", G = "Скриј ја групата", V = "Прошири ја групата", H = "Временска линија", X = "Откажи", W = "Преименувај", Y = "Прекинато", Z = "На чекањe", e = "Се поставува", K = "Прекини", a = "Обиди се повторно", i = "Уреди", l = "Не е најдена ниту една датотека", r = "Спуштете ги датотеките за да ги поставите или кликнете на копчето Постави.", u = "Постави ја колекцијата", d = "Повлечи ги датотеките тука.", g = "Спуштете ги датотеките за да ги поставите.", m = "Лента од процесорот на наредби", b = "Лого", f = "CoPilot", k = "{0} Известувања", p = "Профил", x = "Производи", h = "Производи", j = "Пребарај", q = "Повеќе", v = "Откажи", w = "Лента за информации за напредокот на волшебникот", y = "Чекори на волшебникот", z = "За активирање, притиснете го копчето за празно место или Enter", J = "Чекори", Q = "Изборно", $ = "Активно", TT = "Неактивно", IT = "Чекор {0}", _T = "Волшебник", ET = "Чекор", LT = "Прикажи ги поставките", OT = "Во ред", AT = "Откажи", NT = "Ресетирај", ST = "Редослед на подредување", CT = "Филтрирај според", RT = "Подреди според", DT = "Растечко", MT = "Опаѓачко", UT = "Ајде да постигнеме резултати", BT = "Започнете со наведување на критериумите за пребарување.", PT = "Сè уште немате додадено активности", tT = "Дали би сакале да додадете некоја активност сега?", nT = "Додајте колони за да ја видите содржината", oT = "Изберете ги потребните колони во поставките на табелата.", sT = "Сè уште нема податоци", cT = "Кога ќе има, ќе ги видите овде.", FT = "Нема нова е-пошта", GT = "Провери повторно подоцна.", VT = "Сè уште нема внесови", HT = "Кога ќе има, ќе ги видите овде.", XT = "Немате нови известувања", WT = "Провери повторно подоцна.", YT = "Сè уште немате додадено омилени", ZT = "Дали сакате да создадете список со омилени ставки сега?", eT = "Не се пронајдени резултати", KT = "Обидете се да ги промените критериумите за пребарување.", aT = "Немате нови задачи", iT = "Кога ќе има, ќе ги видите овде.", lT = "Не може да се вчитаат податоците", rT = "Проверете ја интернет-врската. Ако не помогне, обидете се со превчитување. Ако и ова не помогне, контактирајте со администраторот.", uT = "Не може да се вчита слика", dT = "Не можеме да ја пронајдеме сликата на специфицираната локација или серверот не одговара.", gT = "Не може да се вчитаат податоците", mT = "Проверете ја интернет-врската. Ако не помогне, проверете ги форматот и големината на датотеката. Во спротивно, контактирајте со администраторот.", bT = "Мигрирај во SAP Integration Suite", fT = "Префрлете ја вашата содржина за интеграција од постојната претплата за интеграција на процесот во можност за интеграција на облак.", kT = "Изгледа дека има слободен простор", pT = "Може да додадете повеќе колони во поставките на табелата.", xT = "Сè уште немате додадено никого во календарот.", hT = "Дали сакате да додадете некој нов?", jT = "Ценети сте!", qT = "Продолжете со одличната работа!", vT = "Сè уште нема ништо планирано", wT = "Нема активности во оваа временска рамка.", yT = "Опциите за филтрирање се достапни", zT = "Филтрите помагаат да се фокусирате на тоа што ви е најважно.", JT = "Обидете се да ги групирате ставките за подобар преглед", QT = "Може да изберете да групирате категории во поставките за група.", $T = "Не се пронајдени резултати", TI = "Обидете се да ги приспособите критериумите за филтрирање.", II = "За жал, не можеме да ја пронајдеме оваа страница", _I = "Проверете ја URL-адресата што ја користите да ја повикате апликацијата.", EI = "Изберете ја ширината на вашата колона", LI = "Може да ја промените големината на колоните со влечење на границите на колоната.", OI = "Не ги гледате прво најважните ставки?", AI = "Изберете ги критериумите во поставките за подредување.", NI = "Одлично завршена работа!", SI = "Ги завршивте задолженијата за учење.", CI = "Спушти ги датотеките тука", RI = "Исто така, може да поставите неколку датотеки одеднаш.", DI = "Некои димензии недостигаат", MI = "Додајте повеќе димензии за да го пополните дијаграмот.", UI = "Нема податоци за дијаграмот", BI = "Обидете се да ги приспособите поставките на дијаграмот.", PI = "Вашето мислење ни е важно", tI = "Ние сакаме да го слушнеме вашето мислење за софтверот на SAP. Споделете го впечатокот со пополнување на нашата кратка анкета.", nI = "Споредна содржина", oI = "Навигација", sI = "Лента на менито на списокот за навигација", cI = "Ставка на менито на списокот за навигација", FI = "Дрво на списокот за навигација", GI = "Ставка на дрвото на списокот за навигација", VI = "Повеќе ставки", HI = {
