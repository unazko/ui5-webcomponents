...
const styleData = { packageName: "@ui5/webcomponents", fileName: "themes/SelectPopover.css.ts", content: `.ui5-select-popover::part(content),.ui5-select-popover::part(header){padding:0}.ui5-select-popover [ui5-option],.ui5-select-popover [ui5-option-custom]{height:var(--_ui5-v2-0-0-rc-3_list_item_dropdown_base_height)}.ui5-select-popover [ui5-option]::part(icon){color:var(--sapList_TextColor)}
` };
