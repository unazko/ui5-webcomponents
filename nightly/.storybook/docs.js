...
export const DocsPage = (args) => {
    return () => (_jsxs(_Fragment, { children: [_jsxs("header", { children: [_jsx("span", { className: 'sb-ui5-title', children: _jsx(Title, {}) }), args.since && (_jsx("span", { className: 'sb-ui5-component-heading-since', children: _jsxs("b", { children: ["v", args.since] }) }))] }), _jsx("div", { className: 'sb-ui5-component-package', children: _jsx("b", { children: args.package }) }), _jsxs("div", { className: 'sb-ui5-control-tag', children: ["<", args.component, ">"] }), _jsx(Subtitle, {}), _jsx(Description, {}), _jsx("br", {}), _jsx(Primary, {}), _jsx(ArgsTable, { story: PRIMARY_STORY }), _jsx(Stories, {}), _jsx(Footer, {})] }));
};
